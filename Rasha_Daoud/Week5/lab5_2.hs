...
allConstraints = concat [rowConstrnt,columnConstrnt, blockConstrnt]
...
{- Executing main will result into testing 100 random sudoku problem using the random generator & the solver
  refactored code will be used. 
  
  an example of a sudoku problem & solution resulted from the execution of the random tester:
