...
{- Report:
	...
	*Exercise3> strengthList
	...
	Furthermore, as you can see from our quickcheck algorithm is that equivalent properties can be swapped. We can push p eq to p 
	before q or after q in the list.
-}